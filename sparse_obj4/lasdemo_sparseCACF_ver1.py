from mosseCACF_sparse_Ver1 import mosseCACF_sparse_Ver1
import argparse
import os
import numpy as np
...
if __name__ == '__main__':
    ...
    all_dataset = os.listdir("F:/current_code_15_06_202/datasets")
    ...
    tracker = mosseCACF_sparse_Ver1(args, img_path, dataset1)
    #img_path = 'datasets/'+ dataset
    #tracker = mosseCACF_sparse_Ver1(args, img_path, dataset)
